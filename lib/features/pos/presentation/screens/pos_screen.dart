...
class _PosScreenState extends ConsumerState<PosScreen> {
  ...
  Future<void> _generatePdfInvoice(
    ...
    final logo = s['company_logo']?.toString();
      ...
      build: (pw.Context context) => pw.Column(
        ...
        children: [
          pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
            pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
              if (logo != null && logo.isNotEmpty)
                pw.Container(width: 100, height: 50, child: pw.Image(pw.MemoryImage(base64Decode(logo.split(',').last)))),
              pw.Text(company, style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
              if (address != null && address.isNotEmpty) pw.Text(address, style: pw.TextStyle(fontSize: 10)),
              if (phone != null && phone.isNotEmpty) pw.Text('Tel: $phone', style: pw.TextStyle(fontSize: 10)),
              if (email != null && email.isNotEmpty) pw.Text('Email: $email', style: pw.TextStyle(fontSize: 10)),
              if (taxNum != null && taxNum.isNotEmpty) pw.Text('VAT: $taxNum', style: pw.TextStyle(fontSize: 10)),
            ]),
            pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.end, children: [
              pw.Text('INVOICE', style: pw.TextStyle(fontSize: 22, fontWeight: pw.FontWeight.bold)),
              pw.SizedBox(height: 4),
              pw.Text('${s['invoice_prefix']?.toString() ?? 'INV-'}${result.invoiceNumber}', style: pw.TextStyle(fontSize: 12)),
              pw.Text('Date: $dateStr', style: pw.TextStyle(fontSize: 10)),
              pw.Text('Payment: $paymentMethod', style: pw.TextStyle(fontSize: 10)),
              pw.Text('Txn: ${result.transactionNumber}', style: pw.TextStyle(fontSize: 10)),
            ]),
          ]),
          ...
          ...items.map((i) => pw.Row(children: [
            pw.Expanded(flex: 3, child: pw.Text(i.product.name, style: pw.TextStyle(fontSize: 10))),
            pw.Expanded(flex: 1, child: pw.Text('${i.quantity}', style: pw.TextStyle(fontSize: 10))),
            pw.Expanded(flex: 2, child: pw.Text('R ${i.unitPrice.toStringAsFixed(2)}', style: pw.TextStyle(fontSize: 10))),
            pw.Expanded(flex: 2, child: pw.Text('R ${(i.unitPrice * i.quantity).toStringAsFixed(2)}', style: pw.TextStyle(fontSize: 10))),
          ])),
          ...
          if (bank != null && bank.isNotEmpty) ...[
            ...
            pw.SizedBox(height: 4),
            pw.Text('Bank: $bank', style: pw.TextStyle(fontSize: 10)),
            if (holder != null && holder.isNotEmpty) pw.Text('Account Holder: $holder', style: pw.TextStyle(fontSize: 10)),
            if (accNum != null && accNum.isNotEmpty) pw.Text('Account: $accNum', style: pw.TextStyle(fontSize: 10)),
