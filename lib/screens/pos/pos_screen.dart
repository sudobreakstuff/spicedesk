        ...
        if (pos.isEmpty)
                  ...
                  child: Row(children: [
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(it.product.name, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
                    ...
                    Row(mainAxisSize: MainAxisSize.min, children: [
                      IconButton(icon: const Icon(Icons.remove_circle_outline, size: 20), onPressed: () => pos.updateQuantity(i, it.quantity - 1), padding: EdgeInsets.zero, constraints: const BoxConstraints()),
                      SizedBox(width: 22, child: Text('${it.quantity}', textAlign: TextAlign.center, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),
                      IconButton(icon: const Icon(Icons.add_circle_outline, size: 20, color: Colors.blue), onPressed: () => pos.updateQuantity(i, it.quantity + 1), padding: EdgeInsets.zero, constraints: const BoxConstraints()),
                    ]),
                  ]),
                );
              },
          ...
          Container(
            ...
            child: Column(children: [
              ...
              _tr('Total', pos.total, bold: true, size: 16, color: Colors.blue),
